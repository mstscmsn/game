...
export const ENEMIES = {
  /* 灰葬原野 */
  shroudman: { name: '裹尸人', sprite: 'shroud', hp: 12, dmg: 8, speed: 46, r: 13, behavior: 'chase' },
  gravehound: { name: '墓犬', sprite: 'hound', hp: 8, dmg: 6, speed: 92, r: 12, behavior: 'dart' },
  bonecrow: { name: '骨鸦', sprite: 'crow', hp: 5, dmg: 5, speed: 74, r: 10, behavior: 'swarm' },
  diggermonk: { name: '挖墓修士', sprite: 'monk', hp: 22, dmg: 10, speed: 38, r: 14, behavior: 'chase' },
  waxbride: { name: '蜡尸新娘', sprite: 'bride', hp: 30, dmg: 12, speed: 30, r: 14, behavior: 'shoot', proj: { dmg: 9, speed: 150, cd: 3.2 } },
  ashghoul: { name: '灰烬食尸鬼', sprite: 'ashghoul', hp: 15, dmg: 9, speed: 60, r: 13, behavior: 'chase' },
  /* 腐香大教堂 */
  ...
  tidecorpse: { name: '潮尸', sprite: 'tidecorpse', hp: 16, dmg: 8, speed: 78, r: 11, behavior: 'swarm' },
  ...
  hellhound: { name: '狱犬', sprite: 'hound', tint: '#c96b2f', hp: 40, dmg: 16, speed: 105, r: 12, behavior: 'dart' },
  umbilcarrier: { name: '脐带搬运者', sprite: 'monk', tint: '#c96b2f', hp: 90, dmg: 18, speed: 40, r: 14, behavior: 'summoner', summon: 'hellimp', cd: 5 },
  hellimp: { name: '铁花芽', sprite: 'crow', tint: '#D4474F', hp: 14, dmg: 10, speed: 88, r: 10, behavior: 'swarm' },
  facereader: { name: '读脸人', sprite: 'nun', tint: '#c96b2f', hp: 65, dmg: 18, speed: 55, r: 13, behavior: 'orbit' },
  /* 假天堂 */
  cherub: { name: '瓷面天童', sprite: 'cherub', hp: 60, dmg: 18, speed: 62, r: 12, behavior: 'chase', disguised: true },
  ...
  nervewalker: { name: '神经行者', sprite: 'nervewalker', hp: 80, dmg: 22, speed: 72, r: 13, behavior: 'dart' },
  sacredeye: { name: '圣眼', sprite: 'eyeball', hp: 60, dmg: 18, speed: 40, r: 12, behavior: 'shoot', proj: { dmg: 22, speed: 200, cd: 2.0 } },
  prayerclot: { name: '祈祷凝块', sprite: 'tidecorpse', tint: '#7c5f8a', hp: 30, dmg: 14, speed: 84, r: 11, behavior: 'swarm' },
