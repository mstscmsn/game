...
export const TREES = {
  flesh: {
    ...
    nodes: [
      ...
      { id: 'f_speed', name: '送葬者步伐', desc: '移动速度+{v}%', maxRank: 5, per: 3, stat: 'moveSpeed', v: 0.03, cost: r => 80 + r * 110 },
      { id: 'f_dodge', name: '棺盖侧滑', desc: '闪避冷却-{v}%', maxRank: 5, per: 4, stat: 'dodgeCdMult', v: -0.04, cost: r => 90 + r * 120 },
      { id: 'f_inv', name: '死过一次的皮肤', desc: '受伤无敌+{v}秒', maxRank: 2, per: 0.1, stat: 'hurtInv', v: 0.1, flat: true, cost: r => 200 + r * 300 },
  ...
  weaponT: {
    ...
    nodes: [
      ...
      { id: 'w_fusehint', name: '融合启示', desc: '解锁融合图鉴提示，神器保底提前一个宝箱触发', maxRank: 1, stat: 'fuseHint', v: 1, flat: true, cost: () => 250 },
  ...
  memory: {
    ...
    nodes: [
      ...
      { id: 'm_reroll', name: '重掷骨骰', desc: '每局重掷次数+1', maxRank: 3, stat: 'rerolls', v: 1, flat: true, cost: r => 120 + r * 180 },
      { id: 'm_banish', name: '放逐之名', desc: '每局放逐次数+1', maxRank: 2, stat: 'banishes', v: 1, flat: true, cost: r => 300 + r * 300, needPollen: 3 },
      { id: 'm_bless', name: '初始赐福', desc: '开局选择一项赐福', maxRank: 1, stat: 'startBless', v: 1, flat: true, cost: () => 350 },
    ],
  },
  fallen: {
    name: '堕翼遗嘱', res: 'bone',
    nodes: [
      { id: 'd_shield', name: '异议者之盾', desc: '堕翼审判中获得{v}点独立护盾', maxRank: 3, per: 30, stat: 'tribunalShield', v: 30, flat: true, cost: r => 2 + r * 4 },
